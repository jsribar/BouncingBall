...
namespace Vsite.Pood.BouncingBallTests
{
    ...
    public class LineInterSectionsTest
    {
        ...
        [TestMethod]
        public void LineIntersection_GetCollisionPointsReturnsEmptyCollisionPointForNoCollisionPlanes()
        {
            Line line1 = new Line(new PointD(0, 0), new PointD(4, 4));
            LineIntersections li = new LineIntersections(line1);
        ...
        [TestMethod]
        public void LineIntersection_GetCollisionPointsReturnsOneCollisionPointForProperCollisionPlanes()
        {
            Line line1 = new Line(new PointD(0, 0), new PointD(4, 4));
            LineIntersections li = new LineIntersections(line1);
